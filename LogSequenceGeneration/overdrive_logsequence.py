...
x1 = np.geomspace(start=1, stop=65535,  num=N, endpoint=True, dtype=int)
x2 = np.linspace(start=1, stop=65535, num=N, endpoint=True, dtype=int)
...
write_to_source_file(x2, "fade_lin_seq", "fade_lin_seq.c", "fade_lin_seq.h")
